  ...
  return (
    <div>
      <div className="px-20 text-sm">
        ...
        <span className="text-black text-3xl font-normal leading-[33.86px]">
          Cho thuê theo yêu cầu
          <br />
        </span>
        <span className="text-black text-2xl font-normal">
          <br />
        ...
        <span className="text-black text-3xl font-normal leading-[33.86px]">
          Thuê theo số lượng lớn / sự kiện
          <br />
        </span>
        <span className="text-black text-2xl font-normal">
          <br />
        ...
        <span className="text-black text-4xl font-normal leading-10">
        ...
        <span className="text-black text-2xl font-normal">
          <br />
          Hiện tại chúng tôi chưa hỗ trợ cho thuê quốc tế.
          <br />
          Theo dõi đơn hàng:
          <br />
        ...
        <span className="text-black text-2xl font-normal">
          Thẻ nội địa: 2.9% + $0.30
          <br />
          Thẻ quốc tế: 3.9% + $0.30
          <br />
        </span>
        <span className="text-black text-2xl font-normal">
          <br />
        ...
        <span className="text-black text-2xl font-normal">
          Hãy sử dụng cẩn thận; tránh nhiệt độ cao, bụi hoặc nước.
          <br />
          Luôn vệ sinh bằng khăn microfiber và dùng nắp khi không sử dụng.
          <br />
        </span>
        <span className="text-black text-2xl font-normal">
          <br />
        ...
        <span className="text-black text-2xl font-normal">
          Mọi thắc mắc khác vui lòng liên hệ: support@focal.com.
          <br />
          <br />
        </span>
        <span className="text-black text-4xl font-normal leading-10">
        ...
        <span className="text-black text-2xl font-normal">
          ...
          support@focal.com
          <br /> <br />
          Giờ làm việc: Thứ 2 – Chủ Nhật từ 9h sáng đến 9h tối (giờ ET)
          <br />
          (Nghỉ lễ và Chủ Nhật)
        </span>
      </div>
